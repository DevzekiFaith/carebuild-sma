...
export default function AddFundsPage() {
  ...
  const { register, handleSubmit, formState: { errors }, watch, setValue } = useForm<AddFundsFormData>({
    defaultValues: {
      amount: 0,
      paymentMethod: 'card'
    }
  ...
  const onSubmit = async (data: AddFundsFormData) => {
    ...
    try {
      ...
      appToasts.fundsAdded(data.amount);
      router.push('/dashboard?tab=payments');
    } catch (error) {
      appToasts.paymentFailed('Failed to add funds. Please try again.');
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="flex-1 p-4 sm:p-6">
        <NavigationButtons 
          currentPage="Add Funds to Wallet" 
          showHome={false} 
        ...
        >
          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Add Funds to Wallet</h1>
              <p className="text-gray-600">Top up your CareBuild wallet for seamless payments</p>
            </div>

            {/* Current Balance */}
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl mb-8">
              <div className="text-center">
                <p className="text-sm text-gray-600 mb-2">Current Wallet Balance</p>
                <p className="text-4xl font-bold text-gray-900">₦250,000</p>
                <p className="text-sm text-gray-500 mt-2">Available for payments and subscriptions</p>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      max="1000000"
                      step="1000"
                      className={`w-full pl-8 pr-3 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                ...
                {currentAmount > 0 && (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-green-600">Amount to Add</p>
                        <p className="text-2xl font-bold text-green-900">₦{currentAmount.toLocaleString()}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-green-600">New Balance</p>
                        <p className="text-xl font-semibold text-green-900">₦{(250000 + currentAmount).toLocaleString()}</p>
                      </div>
                    </div>
                  </motion.div>
                )}
                ...
                >
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="space-y-2 text-sm">
                      ...
                      <p><strong>Amount:</strong> ₦{currentAmount.toLocaleString()}</p>
                      <p><strong>Reference:</strong> WALLET-{Date.now()}</p>
                    </div>
                  </div>
                </motion.div>
              )}
              ...
              <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-sm text-green-800">
                    ...
                    <p>Your payment information is encrypted and secure. Funds will be added to your wallet immediately after successful payment.</p>
                  </div>
                </div>
              </div>
